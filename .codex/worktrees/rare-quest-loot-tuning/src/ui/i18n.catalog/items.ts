...
const itemStringsEn = {
  itemUi: {
    ...
    market: {
      ...
      browseNote: "Goods listed by adventurers across the realm. Choose Buy to purchase a stack outright.",       searchPlaceholder: "Search market...",       searchAria: "Search the World Market by item name",       emptySearch: "No goods match your search. Try another name.",       truncated: "Showing {shown} of {total} matches. Refine your search to see the rest.",
