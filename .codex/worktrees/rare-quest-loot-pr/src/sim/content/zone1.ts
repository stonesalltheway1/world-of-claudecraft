...
export const ZONE1_MOBS: Record<string, MobTemplate> = {
  ...
  elder_bristleback: {
    ...
    loot: [
      ...
      { itemId: 'bristleback_maul', chance: 0.01 },
      { itemId: 'bristlehide_spaulders', chance: 0.01 },
      { itemId: 'crossroads_saber', chance: 0.01 },
      { itemId: 'moggers_copper_cudgel', chance: 0.005, rollGroup: 'elder_bristleback_chase' },
      { itemId: 'hollowbone_hauberk', chance: 0.005, rollGroup: 'elder_bristleback_chase' },
      { itemId: 'hollowbound_legguards', chance: 0.005, rollGroup: 'elder_bristleback_chase' },
    ],
  ...
  captain_verlan: {
    ...
    loot: [
      ...
      { itemId: 'oathbound_greaves', chance: 0.01 },
      { itemId: 'verlans_oathblade', chance: 0.005, rollGroup: 'verlan_chase' },
      { itemId: 'hollow_vigil_staff', chance: 0.005, rollGroup: 'verlan_chase' },
      { itemId: 'gravewardens_shiv', chance: 0.005, rollGroup: 'verlan_chase' },
    ],
  ...
  brightwood_monarch: {
    ...
    loot: [
      ...
      { itemId: 'monarch_crown_helm', chance: 0.005 },
    ],
